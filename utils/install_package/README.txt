...
Sample syntax for S-104 process query:
    curl -X POST "http://localhost:5000/processes/s100/execution" -H "accept: application/json" -H "Content-Type: application/json" -d "{\"layer\":\"S104\",\"inputs\": {\"bbox\":\"-123.28,49.07,-123.01,49.35\",\"end_time\":\"2021-12-06T23:00:00Z\",\"start_time\":\"2021-12-06T00:00:00Z\"}}" > s104.zip
